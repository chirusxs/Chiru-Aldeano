...
class Econ(commands.Cog):
    ...
    async def leaderboards(self, ctx: Ctx):
        ...
        embed.add_field(
            ...
            value=f"`{ctx.prefix}top antimeraldas`",
        )
    ...
    @leaderboards.command(name="abejas", aliases=["abeja"])
    ...
    @leaderboards.command(name="antimeraldas", aliases=["antimeralda"])
